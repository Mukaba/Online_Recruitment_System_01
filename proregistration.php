...
<nav class="navbar navbar-inverse navbar-static-top">
    ...
    <div class="navbar-header" style="position:fixed"><!-- Navbar header holds the webpage logo and the collapse button-->
        ...
        <a href="#" class="navbar-brand">
            <!-- <img src="" class="img-responsive logo" alt="LOGO"> --> <h4>Online Recruitment System</h4>
        </a>
    </div>
